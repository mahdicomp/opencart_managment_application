...
var ajaxaction = 'index.php?route=extension/module/storeapp/saveComponent&user_token='+user_token;

var save_element_ajaxaction = 'index.php?route=extension/module/storeapp/saveElement&user_token='+user_token;

var save_heading_ajaxaction = 'index.php?route=extension/module/storeapp/saveHeading&user_token='+user_token;

var get_component_ajaxaction = 'index.php?route=extension/module/storeapp/getComponent&user_token='+user_token;
var get_componenttype_ajaxaction = 'index.php?route=extension/module/storeapp/getComponentType&user_token='+user_token;
var delete_ajaxaction = 'index.php?route=extension/module/storeapp/deleteComponent&user_token='+user_token;

var deleteImage_ajaxaction = 'index.php?route=extension/module/storeapp/deleteImage&user_token='+user_token;
    ...
    if (id) {
        ...
        if (num_of_component <= 20) {
            ...
            $.ajax({
                ...
                url: ajaxaction + "&configure=storeapp&assign_component_id=true",
...
function addHtml(id) {
    ...
    if (id) {
        ...
        var html_html = $('.html').html();

        var id_layout = $('#id_layout').val();

        html_html = html_html.replace(/component_position/g, 'layout_component_' + id_layout + '_' + id);

        html_html = html_html.replace(/html_edit_component/g, 'edit_' + id);

        html_html = html_html.replace(/html_delete_component/g, 'delete_' + id);

        $('.slides').append(html_html);
            ...
            $.ajax({
...

                {
                    ...
                    if (id) {
                        ...
                        html_html = html_html.replace(/html_delete_component/g, 'delete_' + id);
                        html_html = html_html.replace(/html_comp_heading/g, 'html_comp_heading_' + id_layout + '_' + id);
                        html_html = html_html.replace(/htmlList/g, 'htmlList_' + id_layout + '_' + id);
                        $('.slides').append(html_html);
...

{
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&getlayoutComponent=true",
...

        {
            ...
            $('#storeapp_configuration_form').hide();
...
function addImage() {
    ...
    var banner_design = $('#bs-banner-design').val();

    var redirect_activity = $('#input-bs-redirect_activity').val();

    
	if(redirect_activity==2){
	  var link_to = $('#input-bs-activity_link_to_product').val();
	}else {
    ...
    if(!banner_errors) {
        ...
        $.ajax({
            ...
            data: 'id_layout=' + id_layout + '&id_component=' + id_component + '&image_url=' + image_url + '&image_content_mode=' + image_content_mode + '+ &banner_design=' + banner_design + '&redirect_activity=' + redirect_activity + '&link_to=' + link_to + '&component_heading=' + component_heading + '&bs_image_row=' + bs_image_row,
            type: "post",
            success: function (data){
                ...
                showSuccessMessage(banner_success_message);
					...
					$("#div-bs-activity_link_to_autocomplate").hide('slow');
                    $('input[name=\'bs_activity_link_to_name\']').val('');
                    $.ajax({
...

{
    ...
    $.ajax({
        ...
        url: get_component_ajaxaction + "&configure=storeapp&getBannerForm=true",
        ...
        {   
            ...
            if(b[0]['heading'].length > 0){
                    ...
                    $('#banner-heading').val(b[0]['heading'][0]['heading']);
...

{
    ...
    $.ajax({
        ...
        url: get_component_ajaxaction + "&configure=storeapp&getBannerCountdownForm=true",
        ...
        {   
            ...
            if(b[0]['heading'].length > 0){
                    ...
                    $('#countdown-heading').val(b[0]['heading'][0]['heading']);
...
function editLayoutName(a) {
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&getlayoutNameForm=true",
...
function saveLayoutData(a) {
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&savelayoutNameForm=true",
...

        {
            ...
            if (1) {
                ...
                $('#storeapp_HOME_PAGE_LAYOUT').html('');

                $('#storeapp_HOME_PAGE_LAYOUT').append(b.layout_select_options);
...
function editProductLAFunction(a)
{
    ...
    $.ajax({
        url: get_component_ajaxaction + "&configure=storeapp&ProductRecent=true",
        data: 'id_layout=' + id_layout + '&id_component=' + id_component,
        type: "post",
        beforeSend: function () {
        ...
        {   
            ...
            if(b.length > 0){
                    ...
                    $('#product-recent').val(b[k]['heading']);
...
function saveHtml(a)
{
  ...
  //console.info(a);
    ...
    var id_component = $('#id_component_selected').val();
       $.ajax({
			url: 'index.php?route=extension/module/storeapp/saveHtml&user_token='+user_token,
			data: 'id_layout=' + id_layout + '&id_component=' + id_component + '&text='+$('#html-text-').val(),
			type: "post",
...
{   
    ...
    $('#id_component_selected').val(id_component);
    $.ajax({
        url: get_component_ajaxaction + "&configure=storeapp&getProductForm=true",
        data: 'id_layout=' + id_layout + '&id_component=' + id_component,
        type: "post",
        beforeSend: function () {
        ...
        {   
            ...
            console.info(b);
            if(b[0]['heading'].length > 0){
                 $('#product-heading').val(b[0]['heading'][0]['heading']);
                 $('#input-product-icon').val(b[0]['heading'][0]['icon']);
                 var url=window.location.href.split('/admin');
                 $("#product-icon-src").attr("src",url[0]+'/image/'+b[0]['heading'][0]['icon']);
...
function saveCountdownHeading(){
    ...
    var id_component = $('#id_component_selected').val();
    error = false;
    $('.front_preview #bannerCountdown_comp_heading_'+id_layout+'_'+id_component).html($('#countdown-heading').val());
   
            $.ajax({
                url: save_heading_ajaxaction,
                data: 'id_layout='+id_layout+'&id_component='+id_component+'&heading='+$('#countdown-heading').val(),
                type: "post",
            });
...
function saveBannerHeading(){
    ...
    error = false;
       ...
       $.ajax({
            url: save_heading_ajaxaction,
            data: 'id_layout='+id_layout+'&id_component='+id_component+'&heading='+$('#banner-heading').val(),
            type: "post",
        });
        $('.bannerSquare  #bannerSquare_comp_heading_'+id_layout+'_'+id_component).html($('#banner-heading').val());
        $('.bannerHorizontalSlide  #bannerHorizontalSlide_comp_heading_'+id_layout+'_'+id_component).html($('#banner-heading').val());
        $('.bannerGrid  #bannerGrid_comp_heading_'+id_layout+'_'+id_component).html($('#banner-heading').val());
...
function saveProductLAHeading(){
    ...
    error = false;
       ...
       $.ajax({
            url: save_heading_ajaxaction,
            data: 'id_layout='+id_layout+'&id_component='+id_component+'&heading='+$('#product-recent').val(),
            type: "post",
        });
        showSuccessMessage(success_heading_message);
...
function saveProductHeading(){
    ...
    error = false;
    $('.front_preview #productGrid_comp_heading_'+id_layout+'_'+id_component).html($('#product-heading').val());
    $('.front_preview #slidingProducts_comp_heading_'+id_layout+'_'+id_component).html($('#product-heading').val());
    $('.front_preview #productSquare_comp_heading_'+id_layout+'_'+id_component).html($('#product-heading').val());
   
            $.ajax({
                url: save_heading_ajaxaction,
                data: 'id_layout='+id_layout+'&id_component='+id_component+'&heading='+$('#product-heading').val()+'&icon='+$('#input-product-icon').val(),
                type: "post",
            });
...
function submitTopCategoryForm() {
	...
	var category_in_home = $('#category-in-home').val();
    // changes started
    var fd = new FormData();
    ...
    if ($('#input-category-image-8').val() != undefined && $('#input-category-image-8').val() !='' && id_category_8 != 0) {
     ...
     fd.append('category_in_home', category_in_home);
    ...
    $('#kbGDPRDialogueModel').find('.icon-trash').parent().each(function () {
        ...
        $(this).bind('click', function () {
            ...
            $.ajax({
                ...
                url: ajaxaction + "&configure=storeapp&deleteTopCategoryImage=true",
...
function editHtmlComponentFunction(a)

{
    ...
    $.ajax({
        ...
        url: get_component_ajaxaction + "&html=true",
        ...
        {   
            ...
            if (html.length > 0) {
                ...
                for (k = 0; k < html.length; k++) {
                   //  alert(html[k]['text']);
                    $('#html-text-').val(html[k]['text']);
        ...
        {   
            ...
            if (b.length > 0) {
                for (i = 0; i < b.length; i++) {
                    ...
                    if(b[i]['id_category'] > 0) {
                         $('#category-in-home').val(b[i]['category_in_home']);
...

{
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&saveBannerSliderFormData=true",
...
function getCustomProduct(product_id) {
    ...
    html = '';
    $.ajax({
        url: 'index.php?route=extension/module/storeapp/selectProduct&user_token='+user_token,
        dataType: 'json',
...

{
    ...
    $.ajax({
        ...
        url: save_element_ajaxaction + "&configure=storeapp&saveProductFormData=true",
...
function delete_banner_slider(a) {
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&deleteSliderBanner=true",
...

        {
            ...
            if (1) {
                ...
                $.ajax({
                    ...
                    url: ajaxaction + "&configure=storeapp&getComponentType=true",
...
function trashBannerSquareComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: delete_ajaxaction + "&configure=storeapp&deleteBannerSquarecomponent=true",
...
function trashLastAccessComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: delete_ajaxaction + "&configure=storeapp&deleteLastAccesscomponent=true",
...
function trashProductHorizontalComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: delete_ajaxaction + "&configure=storeapp&deleteProductcomponent=true",
...
function trashTopcategoryComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: delete_ajaxaction + "&configure=storeapp&deleteTopcategorycomponent=true",
...
function trashBannerCountdownComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: ajaxaction + "&configure=storeapp&deleteBannerCountdowncomponent=true",
...
function trashHtmlComponentFunction(a) {
    ...
    $.ajax({
        ...
        url: delete_ajaxaction + "&configure=storeapp&deleteHtmlcomponent=true",
