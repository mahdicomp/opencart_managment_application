<?php
class ControllerExtensionApi32AccountLogin extends Controller {
	private $error = array();
...
//echo $cart['product_id'];
	...
	protected function validate() {
		...
		if (!$this->error) {
			if (!$this->customer->login($username, $this->convertPersianNumbersToEnglish($this->request->post['password']))) {
