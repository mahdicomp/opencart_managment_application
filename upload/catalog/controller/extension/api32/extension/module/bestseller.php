<?php
class ControllerExtensionApi32ExtensionModuleBestSeller extends Controller {
	...
	//	print_r($filter_data);
		...
		$results = $this->model_extension_api_catalog_product->getBestSellerProducts($filter_data);
           $data['count']=false;
		if ($results) {
