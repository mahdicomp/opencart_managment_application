<?php
class ControllerExtensionApi32ExtensionModulePopular extends Controller {
  ...
  //  print_r($filter_data );
		$results = $this->model_extension_api_catalog_product->getPopularProducts($filter_data);
     $data['count']=false;
		if ($results) {
		    $data['result'] = "ok";
