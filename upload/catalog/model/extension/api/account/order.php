<?php
class ModelExtensionApiAccountOrder extends Model {
	...
	public function getOrders($start = 0, $limit = 20,$customer_id) {
		if ($start < 0) {
			$start = 0;
		}
    ...
    public function getOrderBystatus($order_status_id,$customer_id) {
		$query = $this->db->query("SELECT o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" . (int)$customer_id . "' AND o.order_status_id = '" . (int)$order_status_id . "' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "' AND os.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY o.order_id DESC ");
	...
	public function getOrderTotals($order_id) {
		...
		public function getOrderStatusTotal($order_status_id,$customer_id) {
		
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order`  WHERE customer_id = '" . (int)$customer_id . "' AND order_status_id = '" . (int)$order_status_id . "' AND store_id = '" . (int)$this->config->get('config_store_id') . "'");
